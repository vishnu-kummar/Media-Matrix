                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="animate-fadeInLeft">
                        ...
                        <div className="flex flex-wrap gap-4 mb-10">
                            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-orange-600 to-orange-800 text-white font-bold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                        ...
                        <div className="max-w-screen-xl mx-auto px-4 relative z-10">
                            ...
                            <div className="animate-fadeInLeft">
                                ...
                                <div className="flex flex-wrap gap-3 mb-8 justify-center">
                                    ...
                                    <Link to="/contact" className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-gradient-to-r from-orange-600 to-orange-800 text-white text-sm font-bold shadow-lg">
                                        Get Free Consultation
                                    </Link>
